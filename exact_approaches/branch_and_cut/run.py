"""
Command-line Runner for Branch & Cut.
Entry point: loads JSON instance, runs solver, writes JSON solution, generates viewer.
Usage: python -m exact_approaches.branch_and_cut.run --input <instance.json> --output <solution.json>
"""
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Solve an Orienteering Problem instance with Branch and Cut.")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/branch_and_cut/example_op_solution.json"),
