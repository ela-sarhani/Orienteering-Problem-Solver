"""
HTML Viewer Generator for Dynamic Programming Algorithm Visualization.
Creates an interactive HTML file that animates DP state space exploration.
...
<head>
    ...
    <title>Dynamic Programming Graph Progression Viewer</title>
...
<body>
    <div class="container">
        <div class="title">
            <h1>Dynamic Programming State Space Exploration</h1>
            <p>Vertices are labeled with profit. Every arc is labeled with travel cost. Step through DP states, visited nodes, and budget constraints.</p>
        </div>
        ...
        <div class="kpis">
            ...
            <div class="kpi"><div class="label">States Explored</div><div class="value" id="exploredValue">0</div></div>
            <div class="kpi"><div class="label">States Pruned</div><div class="value" id="prunedValue">0</div></div>
        </div>
        ...
        <div class="layout">
            <div class="panel">
                ...
                <div class="legend">
                    ...
                    <span class="chip accepted">current path arcs</span>
                    <span class="chip tested">candidate arcs</span>
                    <span class="chip pruned">pruned arcs</span>
                </div>
            </div>
            <div class="panel">
