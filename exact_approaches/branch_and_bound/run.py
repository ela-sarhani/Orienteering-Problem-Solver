"""
Command-line Runner for B&B.
Entry point: loads JSON instance, runs B&B solver, writes JSON solution.
Usage: python -m exact_approaches.branch_and_bound.run --input <instance.json> --output <solution.json>
"""
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Solve an Orienteering Problem instance with Branch and Bound.")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/branch_and_bound/example_op_solution.json"),
