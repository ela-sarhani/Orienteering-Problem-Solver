"""Command-line runner for the Tabu Search approach."""
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Solve an Orienteering Problem instance with Tabu Search.")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/metaheuristics/tabu_search/example_op_solution.json"),
