"""Command-line runner for the GRASP approach."""
...
from .solver import GraspSolver
from .visualization.viewer import generate_html_viewer


def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Solve an Orienteering Problem instance with GRASP.")
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/metaheuristics/grasp/example_op_solution.json"),
